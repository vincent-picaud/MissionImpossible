...
*Note:* you must *always* initialize =AD<T>= variables before usage (in order to register them in the tape)
...
function that takes a *scalar* constant =10= and compute =10*x*x=, you must
